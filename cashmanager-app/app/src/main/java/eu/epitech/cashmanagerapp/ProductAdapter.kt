...
class ProductAdapter(var context: Context, var products: List<ProductModel> = arrayListOf()) :
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        (context as CatalogActivity).coordinator
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindProduct(product: ProductModel) {
            ...
            Picasso.get().load(product.pictureModels[0].filename).fit().into(itemView.product_image)
...
//                ShoppingCart.addItem(item)
            ...
            Observable.create(ObservableOnSubscribe<MutableList<CartItem>> {
                ...
                itemView.addToCart.setOnClickListener { view ->
                    ...
                    //notify users
                    Snackbar.make(
                        (itemView.context as CatalogActivity).coordinator,
                ...
                (itemView.context as CatalogActivity).cart_size.text = quantity.toString()
